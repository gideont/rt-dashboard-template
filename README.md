...
**Questions or want to collaborate?** Welcome — this template is designed to be approachable and easy to extend. If you'd like to contribute, ask questions, or discuss improvements, email gideont@gmail.com and let's build together — we'd be happy to help.
